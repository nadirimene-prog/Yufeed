export const complianceKeys = {
  ...
  policiesList: (params: Record<string, unknown>) =>
    [...complianceKeys.policies(), "list", params] as const,
  policyDetail: (id: number) =>
    [...complianceKeys.policies(), "detail", id] as const,
  policySections: (id: number) =>
    [...complianceKeys.policyDetail(id), "sections"] as const,
...
export const monitoringKeys = {
  ...
  alertDetail: (id: number | string) =>
    [...monitoringKeys.alerts(), "detail", id] as const,
  cases: () => [...monitoringKeys.all, "cases"] as const,
  casesList: (params: Record<string, unknown>) =>
    [...monitoringKeys.cases(), "list", params] as const,
  caseDetail: (id: number | string) =>
    [...monitoringKeys.cases(), "detail", id] as const,
  rules: () => [...monitoringKeys.all, "rules"] as const,
  rulesList: (params: Record<string, unknown>) =>
    [...monitoringKeys.rules(), "list", params] as const,
  ruleDetail: (id: number | string) =>
    [...monitoringKeys.rules(), "detail", id] as const,
...
export const watchlistKeys = {
  ...
  entries: (watchlistId: number | string) =>
    [...watchlistKeys.detail(watchlistId), "entries"] as const,
} as const;
...
export const amlOfficerKeys = {
  ...
  sarList: (params: Record<string, unknown>) =>
    [...amlOfficerKeys.sar(), "list", params] as const,
...
export const modelRegistryKeys = {
  ...
  modelsList: (params: Record<string, unknown>) =>
    [...modelRegistryKeys.models(), "list", params] as const,
