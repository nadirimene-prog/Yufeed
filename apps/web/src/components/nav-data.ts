...
export const NAV_AREAS: NavArea[] = [
    ...
    },
    {
        ...
        icon: ShieldAlert,
        defaultHref: "/alerts",
        routePrefixes: ["/alerts", "/cases", "/transaction-alerts", "/sar", "/audit", "/network-analysis"],
    ...
    },
    {
        ...
        routePrefixes: ["/transaction-monitoring", "/decisioning", "/travel-rule", "/onchain-risk", "/monitoring"],
