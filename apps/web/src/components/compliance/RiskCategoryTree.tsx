...
import type { RiskCategoryTree as RiskCategoryTreeType, RiskLevelType } from "@/types/compliance";
...
function TreeNode({ category, level, selectedCategoryId, onSelectCategory }: TreeNodeProps) {
        ...
        <div>
            ...
            >
                ...
                {hasChildren ? (
                    ...
                    <AlertTriangle className={cn("h-4 w-4", getRiskLevelColor(category.risk_level))} />
                )}
    ...
    return (
        <div className={cn("space-y-1", className)}>
            ...
            <div
                ...
                onClick={() => onSelectCategory?.(null as unknown as RiskCategoryTreeType)}
            >
                <span className="w-5" />
