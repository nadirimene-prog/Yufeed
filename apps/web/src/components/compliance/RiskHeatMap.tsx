...
const getRiskLevel = (
  ...
  const likelihoodIdx = likelihoodLabels.findIndex(
    (l) => l.value === likelihood,
  );
...
const getCellColor = (
  ...
  switch (level) {
    case "critical":
      return "bg-red-500/40 hover:bg-red-500/50 ring-2 ring-red-500/30";
    case "high":
      return "bg-orange-500/40 hover:bg-orange-500/50 ring-2 ring-orange-500/30";
    case "medium":
      return "bg-yellow-500/40 hover:bg-yellow-500/50 ring-2 ring-yellow-500/30";
    case "low":
      return "bg-green-500/40 hover:bg-green-500/50 ring-2 ring-green-500/30";
  }
};
