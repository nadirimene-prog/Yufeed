      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <div className="relative lg:col-span-2">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 border border-slate-300  rounded-md bg-white  text-sm text-slate-900 "
        ...
        <select
          className="px-3 py-2 border border-slate-300  rounded-md bg-white  text-sm text-slate-900 "
        ...
        <input
          ...
          className="lg:col-span-1 px-3 py-2 border border-slate-300  rounded-md bg-white  text-sm text-slate-900 "
