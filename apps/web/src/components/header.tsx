          ...
          >
            <SearchInput
              ...
              className={cn(
                ...
                searchFocused && "glow-primary border-primary/30",
              )}
            />
            ...
            <AnimatePresence>
              {searchFocused && (
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(ellipse at center, rgba(109, 90, 205, 0.15) 0%, transparent 70%)",
                  }}
                />
              )}
            </AnimatePresence>
        ...
        <div className="flex items-center gap-2">
          ...
          <Tooltip content="AI Officer" side="bottom">
            ...
            >
              ...
              {/* Pulsing indicator */}
              <motion.span
                className="absolute -top-0.5 -right-0.5 h-2 w-2 rounded-full bg-risk-low"
                animate={{
                  scale: [1, 1.3, 1],
                  opacity: [1, 0.5, 1],
                }}
          ...
          <div className="relative" ref={menuRef}>
            ...
            >
              ...
              <div className="relative">
                ...
                />
                <div className="relative h-8 w-8 rounded-full bg-background flex items-center justify-center">
                  <span className="text-xs font-bold text-foreground">AU</span>
                </div>
                {/* Online indicator */}
                <span className="absolute -bottom-0.5 -right-0.5 h-2.5 w-2.5 rounded-full bg-risk-low border-2 border-background" />
              </div>
              ...
              {/* Dropdown indicator */}
              <ChevronRight className="h-3.5 w-3.5 text-muted-foreground/50 rotate-90 hidden md:block" />
            </motion.button>
            ...
            <AnimatePresence>
              {menuOpen && (
                <motion.div
                  ...
                  role="menu"
                >
                  <div className="px-3 py-2 text-[11px] uppercase tracking-[0.2em] text-muted-foreground/70">
                    Workspace
                  </div>
                  ...
                  <div className="p-2 space-y-1">
                    <Link
                      href="/profile"
                      className="flex items-center gap-2 rounded-lg px-2.5 py-2 text-sm text-muted-foreground hover:text-foreground hover:bg-sidebar-accent/50"
                  ...
                  <button
                    ...
                    className="flex w-full items-center gap-2 px-4 py-2.5 text-sm text-risk-critical hover:bg-risk-critical-soft"
                    role="menuitem"
                  >
