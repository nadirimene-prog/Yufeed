            ...
            {searchable && (
              <div className="relative flex-1 sm:flex-none">
                ...
                <input
                  ...
                  className="w-full sm:w-64 pl-9 pr-4 py-2 rounded-lg border border-border bg-background text-sm placeholder:text-foreground-tertiary focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                />
              </div>
            )}
            {exportable && onExport && (
