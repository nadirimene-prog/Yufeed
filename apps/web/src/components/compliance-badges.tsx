...
export { RiskBadge, RiskScoreBadge, type RiskLevel, type BadgeSize } from '@/components/ui/risk-badge';
...
export function ComplianceDomainBadge({ domain, className = "" }: ComplianceDomainBadgeProps) {
    ...
    const color = colors[domain.toLowerCase() as keyof typeof colors] || colors.other;
