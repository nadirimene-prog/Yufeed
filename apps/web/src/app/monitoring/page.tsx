          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <Activity
                  className={`h-5 w-5 ${metrics?.system_status === "operational" ? "text-green-600" : "text-red-600"}`}
                />
      ...
      <div className="flex items-start justify-between mb-2">
        <div className="flex-1">
          <div className="flex items-center space-x-2 mb-1">
            ...
            <span
              className={`text-xs px-2 py-1 rounded-full ${severityColors[alert.severity as keyof typeof severityColors]}`}
            >
              {alert.severity}
            </span>
          </div>
      ...
      <div className="flex items-start justify-between mb-2">
        ...
        <div className="text-right">
          {transaction.risk_level && (
            <span
              className={`text-sm font-semibold ${riskColors[transaction.risk_level as keyof typeof riskColors]}`}
            >
