    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <BarChart3 className="h-12 w-12 animate-spin mx-auto mb-4 text-blue-600" />
          <p className="text-lg text-gray-700 dark:text-gray-300">Loading compliance metrics...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300">Unable to load metrics</p>
        </div>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              ...
              <ResponsiveContainer width="100%" height={250}>
                <PieChart>
                  <Pie
                    data={Object.entries(metrics.alert_metrics.by_severity).map(([name, value]) => ({
                    ...
                    dataKey="value"
                  >
                    {Object.keys(metrics.alert_metrics.by_severity).map((severity, index) => (
            ...
            >
              ...
              <ResponsiveContainer width="100%" height={250}>
                <BarChart
                  data={Object.entries(metrics.alert_metrics.by_status).map(([name, value]) => ({
                    name: name.replace(/_/g, ' '),
                    value
                  }))}
                >
                  <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                  <XAxis dataKey="name" tick={{ fontSize: 12 }} angle={-15} textAnchor="end" height={70} />
                  <YAxis />
                  <Tooltip />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Avg Investigation Time</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(metrics.transaction_metrics.total_volume).map(([currency, amount]) => (
                <div key={currency} className="text-center p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg shadow p-6 border border-blue-200 dark:border-blue-800">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Linked to Regulations</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-blue-600 mb-2">
                  {metrics.regulatory_coverage.regulatory_coverage_rate.toFixed(1)}%
                </p>
            ...
            <div className="mt-6 p-4 bg-white dark:bg-gray-800 rounded-lg">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Regulatory coverage measures the percentage of monitoring rules that are linked to specific EU regulations.
                Higher coverage ensures that all alerts include regulatory context and compliance explanations.
              </p>
            </div>
          </div>
        </div>
