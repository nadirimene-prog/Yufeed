...
export default function OnchainRiskPage() {
    const [address, setAddress] = useState("0x9fB1b2e8cB8bB0b1111111111111111111111111");
    ...
    return (
        <div className="min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
            <div className="max-w-4xl mx-auto space-y-6">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">On-chain Risk</h1>
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-950 space-y-4">
                    ...
                    <div>
                        <label className="text-xs font-semibold uppercase text-gray-500">Wallet Address</label>
                        <input
                            value={address}
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                        <div>
                            <label className="text-xs font-semibold uppercase text-gray-500">Chain</label>
                            <input
                                value={chain}
                        ...
                        <div>
                            <label className="text-xs font-semibold uppercase text-gray-500">Asset</label>
                            <input
                                value={asset}
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-950">
                    <h2 className="text-sm font-semibold text-gray-900 dark:text-white">Score Result</h2>
                    {result ? (
