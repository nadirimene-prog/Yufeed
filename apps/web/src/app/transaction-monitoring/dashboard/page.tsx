      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-950 transition-all"
          >
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {MOCK_ALERTS.map((alert) => (
                <tr
                  key={alert.id}
                  className="group hover:bg-gray-50/50 dark:hover:bg-gray-900/30 transition-colors cursor-pointer"
                >
                  <td className="px-6 py-4 text-sm font-medium text-blue-600 dark:text-blue-400">
                    <a href={`/transaction-monitoring/alerts/${alert.id}`}>
                      {alert.id}
                    </a>
                  </td>
                      ...
                      className={cn(
                        ...
                        alert.status === "pending"
                          ...
                          : alert.status === "in_review"
                            ? "bg-purple-50 text-purple-700 dark:bg-purple-500/10"
