...
export default function PolicyDetailPage() {
    ...
    return (
      <div className="space-y-4">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm text-indigo-600 hover:underline dark:text-indigo-300"
        >
  ...
  if (!policy) {
    return <div className="text-sm text-gray-500">Policy not found.</div>;
  }
    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500">{policy.policy_id}</p>
        </div>
      ...
      <section className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        {policy.content ? (
          <pre className="mt-4 whitespace-pre-wrap text-sm leading-6 text-gray-700 dark:text-gray-200">
            {policy.content}
          </pre>
        ) : (
        ...
        <div className="mt-4 space-y-4">
          {sections.length === 0 ? (
            ...
            sections.map((section) => (
              <article
                key={section.id}
                className="rounded-lg border border-gray-100 bg-gray-50/60 p-4 dark:border-slate-800 dark:bg-slate-800/30"
              >
                <div className="flex flex-wrap items-center gap-2">
