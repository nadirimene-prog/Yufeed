...
export default function DashboardPage() {
  ...
  const policiesInReview =
    (policySummary?.by_status?.draft ?? 0) +
    (policySummary?.by_status?.in_review ?? 0);
      ...
      >
        <div>
          ...
          <p className="text-white/50 mt-2 max-w-2xl">
            Regulation → Internal Controls → Auditable Evidence. Operational
            overview for PSP / EME / VASP.
          </p>
        </div>
      ...
      <motion.div variants={staggerItem}>
        <BentoGrid columns={4} gap="md">
          <MetricCard
            ...
            trend={{
              direction:
                (intake?.new_documents.total_7d ?? 0) > 0 ? "up" : "neutral",
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {intake?.new_documents.by_jurisdiction
                  ? Object.entries(intake.new_documents.by_jurisdiction).map(
                      ([jurisdiction, count]) => (
                        <span
                          key={jurisdiction}
          ...
          <GlassCardHeader className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-white/40 mt-1">
                Real-time alerts, cases, and decisioning.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    },
                    {
                      ...
                      value: reporting?.travel_pending ?? 0,
                      color: "purple",
                    },
                  ].map((stat) => (
                    <div
