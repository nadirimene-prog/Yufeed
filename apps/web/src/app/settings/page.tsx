      ...
      <div className="grid gap-4 md:grid-cols-2">
        <GlassCard variant="surface" className="bg-white/[0.02] border border-white/[0.06]">
          <GlassCardHeader>
            ...
            <GlassCardDescription>Profile details, security, and session controls.</GlassCardDescription>
          </GlassCardHeader>
        ...
        <GlassCard variant="surface" className="bg-white/[0.02] border border-white/[0.06]">
          <GlassCardHeader>
            ...
            <GlassCardDescription>Real-time alerts and email preferences.</GlassCardDescription>
          </GlassCardHeader>
          <GlassCardContent className="text-sm text-white/70">
            Coming soon.
          </GlassCardContent>
        ...
        <GlassCard variant="surface" className="bg-white/[0.02] border border-white/[0.06]">
          <GlassCardHeader>
            ...
            <GlassCardDescription>API keys and integration settings.</GlassCardDescription>
          </GlassCardHeader>
          <GlassCardContent className="text-sm text-white/70">
            Coming soon.
          </GlassCardContent>
        ...
        <GlassCard variant="surface" className="bg-white/[0.02] border border-white/[0.06]">
          <GlassCardHeader>
            ...
            <GlassCardDescription>Workspace defaults and administrative preferences.</GlassCardDescription>
          </GlassCardHeader>
          <GlassCardContent className="text-sm text-white/70">
            Coming soon.
          </GlassCardContent>
