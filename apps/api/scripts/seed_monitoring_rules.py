    ...
    try:
        ...
        rules_data.append(
            {
                ...
                "thresholds": {"transaction_count": 10, "time_window_hours": 24},
        ...
        rules_data.append(
            {
                ...
                "severity": "high",
                "conditions": {"conditions": [], "logic": "AND"},
                "thresholds": {"transaction_count": 20, "time_window_hours": 24},
        ...
        rules_data.append(
            {
                ...
                "severity": "high",
                "conditions": {"conditions": [], "logic": "AND"},
                "thresholds": {"total_amount": 100000, "time_window_hours": 24},
        ...
        for rule_data in rules_data:
            ...
            existing = (
                ...
                .filter(MonitoringRule.rule_id == rule_data["rule_id"])
                .first()
            )
        ...
        categories = (
            db.query(MonitoringRule.category, func.count(MonitoringRule.id).label("count"))
