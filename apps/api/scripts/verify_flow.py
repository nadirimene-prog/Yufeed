...
def test_api_flow():
    print(
        "WARNING: Ideally run this with backend running: `uvicorn src.main:app --host 0.0.0.0 --port 8000`"
    )
    ...
    try:
        r = requests.get(
            f"{API_URL}/search", params={"q": "General Data Protection", "type": "regulation"}
        )
