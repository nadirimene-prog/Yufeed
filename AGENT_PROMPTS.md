...
YOUR FIRST TASKS:
1. Create backend/src/websocket/ directory with:
...
3. Create backend/src/api/realtime.py with live metrics endpoint
...
- Explore existing components in frontend/src/components/
...
YOUR FIRST TASKS:
1. Create frontend/src/components/alerts/unified-alert-queue.tsx
2. Create frontend/src/components/alerts/customer-grouped-alerts.tsx
3. Create frontend/src/components/investigation/customer-console.tsx
4. Create frontend/src/components/investigation/risk-timeline.tsx
...
- Explore existing APIs in backend/src/api/
...
YOUR FIRST TASKS:
1. Add /api/alerts/unified endpoint to backend/src/api/alerts.py
2. Create backend/src/api/customers.py with investigation endpoint
3. Create backend/src/services/analytics.py for data aggregation
...
PATTERNS TO FOLLOW:
- Use existing patterns from backend/src/api/
- Follow existing model patterns from backend/src/models/
...
- Explore existing AI code in backend/src/ai/
...
YOUR FIRST TASKS:
1. Create backend/src/ai/rule_parser.py (NLP → Rule DSL)
2. Create backend/src/ai/rule_validator.py (conflict detection)
3. Create backend/src/services/backtest_engine.py
4. Create backend/src/services/shadow_mode.py
...
- Follow existing patterns in backend/src/ai/
...
YOUR FIRST TASKS:
1. Create backend/src/reporting/__init__.py
2. Create backend/src/reporting/pdf_generator.py
3. Create backend/src/reporting/excel_generator.py
4. Create backend/src/reporting/templates/ directory with HTML templates
5. Create backend/src/reporting/scheduler.py
...
- Explore existing compliance code in backend/src/compliance/
...
YOUR FIRST TASKS:
1. Create backend/src/compliance/sar_workflow.py (state machine)
2. Create backend/src/compliance/filing_tracker.py
3. Create backend/src/audit/__init__.py
4. Create backend/src/audit/models.py (AuditLog)
5. Create backend/src/audit/middleware.py
...
- Explore existing tests in backend/tests/ and frontend/src/__tests__/
...
2. Create backend/tests/test_rule_parser.py
3. Create backend/tests/test_backtest_engine.py
4. Create backend/tests/test_unified_alerts.py
5. Create frontend/src/__tests__/unified-alert-queue.test.tsx
...
2. Create backend/celery_app.py configuration
