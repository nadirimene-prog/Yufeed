...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('transaction_type', sa.String(50)),  # 'deposit', 'withdrawal', 'transfer', 'payment'
    ...
    op.create_table(
        ...
        sa.Column('alert_type', sa.String(100), nullable=False),  # 'velocity', 'structuring', 'unusual_pattern', etc.
        ...
        # Status workflow
        sa.Column('status', sa.String(50), default='pending'),  # 'pending', 'in_review', 'escalated', 'resolved', 'false_positive'
    ...
    op.create_table(
        ...
        # Status
        sa.Column('status', sa.String(50), default='open'),  # 'open', 'in_progress', 'escalated', 'closed'
        ...
        # Outcomes
        sa.Column('outcome', sa.String(100)),  # 'sar_filed', 'no_action', 'account_closed', 'escalated'
    ...
    op.create_table(
        ...
        # Rule type
        sa.Column('category', sa.String(100)),  # 'velocity', 'structuring', 'unusual_behavior', 'sanctions'
    ...
    op.create_index('ix_user_risk_profiles_risk_score', 'user_risk_profiles', ['overall_risk_score'])
    ...
    op.create_index('ix_feature_values_lookup', 'feature_values', ['entity_type', 'entity_id', 'feature_name'])
