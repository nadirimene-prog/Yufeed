...
def upgrade() -> None:
    ...
    op.create_index('ix_legal_documents_compliance_domain', 'legal_documents', ['compliance_domain'])
    op.create_index('ix_legal_documents_risk_level', 'legal_documents', ['risk_level'])
    op.create_index('ix_legal_documents_implementation_deadline', 'legal_documents', ['implementation_deadline'])
    ...
    op.create_index('ix_legal_documents_deadline_status', 'legal_documents', ['implementation_deadline', 'status'])
    op.create_index('ix_legal_documents_risk_domain', 'legal_documents', ['risk_level', 'compliance_domain'])
