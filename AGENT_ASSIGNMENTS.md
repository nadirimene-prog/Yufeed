...
# backend/src/websocket/events.py
# backend/src/websocket/broadcaster.py
...
```python
# Create: backend/src/api/realtime.py
...
```typescript
// Create: frontend/src/components/command-center/index.tsx
...
```typescript
// Create: frontend/src/components/command-center/geographic-heatmap.tsx
...
```typescript
// Create: frontend/src/components/alerts/unified-alert-queue.tsx
...
```typescript
// Create: frontend/src/components/investigation/customer-console.tsx
...
```typescript
// Create: frontend/src/components/investigation/risk-timeline.tsx
...
```typescript
// Create: frontend/src/components/investigation/embedded-analytics.tsx
...
```python
# Modify: backend/src/api/alerts.py
...
```python
# Create: backend/src/services/analytics.py
...
```python
# Create: backend/src/ai/rule_parser.py
...
```python
# Create: backend/src/ai/rule_validator.py
...
```python
# Create: backend/src/services/backtest_engine.py
...
```python
# Create: backend/src/services/shadow_mode.py
...
```python
# Create: backend/src/ml/model_registry.py
...
# Create: backend/src/ml/drift_detection.py
...
```python
# Create: backend/src/reporting/pdf_generator.py
...
class PDFReportGenerator:
    def __init__(self):
        self.template_env = Environment(
            loader=FileSystemLoader('backend/src/reporting/templates')
        )
        self.base_css = CSS(filename='backend/src/reporting/templates/base.css')
...
```
backend/src/reporting/templates/
├── base.css
├── sar_summary.html
...
```python
# Create: backend/src/reporting/excel_generator.py
...
```python
# Create: backend/src/reporting/scheduler.py
...
```python
# Create: backend/src/compliance/sar_workflow.py
...
```python
# Create: backend/src/compliance/filing_tracker.py
...
# Create: backend/src/audit/middleware.py
